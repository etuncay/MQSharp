...
namespace SampleClient
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var client = new MqttClient("127.0.0.1", 8885, "sample-client", "sample-client", "P@ssw0rd1", true, null, clientCert, true, 60, TLS_PROTOCOL_VERSION.TLS_1_2, MQTT_PROTOCOL_VERSION.MQTT_3_1_1);
