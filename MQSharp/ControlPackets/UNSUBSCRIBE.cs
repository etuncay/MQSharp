...
{
    internal class UNSUBSCRIBE : ControlPacket
    {
        ...
        public UNSUBSCRIBE(string[] topics, QoS_Level[] qosLevels, MQTT_PROTOCOL_VERSION protoclVersion)
        {
            _topics = topics;
        ...
        public byte[] GetPacketData()
        {
            ...
            Array.Copy(CONTROL_PACKET_TYPE_UNSUBSCRIBE, 0, packetData, packetDataIndex, CONTROL_PACKET_TYPE_UNSUBSCRIBE.Length);
            packetDataIndex += CONTROL_PACKET_TYPE_UNSUBSCRIBE.Length;
